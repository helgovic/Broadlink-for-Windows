...
begin
   ...
   for i := 0 to StatParts.Count - 1 do
      begin
         ...
         then
            TBColorTemp.Position := StrToInt(StrAfter('=', StatParts[i]));
         ...
         if StrBefore('=', StatParts[i]) = 'bulb_colormode'
         then
            ACBColorMode.ItemIndex := StrToInt(StrAfter('=', StatParts[i]));

//         if StrBefore('=', StatParts[i]) = 'bulb_scene'
//         then
//            ACBColorMode.ItemIndex := StrToInt(StrAfter('=', StatParts[i]));
//
...
begin
   ...
   StatParts.Add('colortemp=' + TBColorTemp.Position.ToString);
   ...
   StatParts.Add('bulb_colormode=' + IntToStr(ACBColorMode.ItemIndex));
