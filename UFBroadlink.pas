...
type
  TFBroadlink = class(TForm)
    ...
    procedure TCheckInetTimer(Sender: TObject);
  private
...
procedure TFBroadlink.TCheckInetTimer(Sender: TObject);
...
begin
   ...
   InternetGetConnectedState(@origin,0);
   ...
   then
      begin
         ...
         TCheckInet.Enabled := False;

         DMBroadlink.UCCommonDB.PerformConnect(True);
